...
public interface MiLenguajeVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#spec_body1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpec_body1(MiLenguajeParser.Spec_body1Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#function_stmt1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunction_stmt1(MiLenguajeParser.Function_stmt1Context ctx);
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#function_stmt2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunction_stmt2(MiLenguajeParser.Function_stmt2Context ctx);
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#function_stmt3}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunction_stmt3(MiLenguajeParser.Function_stmt3Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#if_stmt1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf_stmt1(MiLenguajeParser.If_stmt1Context ctx);
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#if_stmt2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf_stmt2(MiLenguajeParser.If_stmt2Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#guarded_cmd_lp1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGuarded_cmd_lp1(MiLenguajeParser.Guarded_cmd_lp1Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#paren_list1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParen_list1(MiLenguajeParser.Paren_list1Context ctx);
	/**
	 * Visit a parse tree produced by {@link MiLenguajeParser#paren_list2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParen_list2(MiLenguajeParser.Paren_list2Context ctx);
	/**
